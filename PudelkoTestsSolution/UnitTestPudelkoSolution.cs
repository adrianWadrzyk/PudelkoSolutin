...
namespace PudelkoTestsSolution
{
    [TestClass]
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        public void Capacity_Test_3_Param(double a, double b, double c, double expectedCapacity)
        {
            Pudelko p = new Pudelko(a, b, c);
            Assert.AreEqual(p.Capacity, expectedCapacity);
        }
        ...
        public void Capacity_Test_1_Param(double a, double expectedCapacity)
        {
            Pudelko p = new Pudelko(a);
            Assert.AreEqual(p.Capacity, expectedCapacity);
        }
        ...
        [DataTestMethod, TestCategory("Capacity")]
        [DataRow(10, 2, 5, UnitOfMeasure.centimeter, 0.0001)]
        [DataRow(100, 200, 500, UnitOfMeasure.centimeter, 10)]
        public void Capacity_Test_3_Param_Centimeter(double a, double b, double c, UnitOfMeasure unit, double expectedCapacity)
        {
        ...
        [DataTestMethod, TestCategory("Surface")]
        [DataRow(10, 10, 10, 600)]
        [DataRow(1, 1, 1, 6)]
        [DataRow(2.4, 3.4, 5.3, 77.8)]

        public void Surface_Test_3_Param(double a, double b, double c, double expectedSurface)
        {
            Pudelko p = new Pudelko(a, b, c);
            Assert.AreEqual(p.Surface, expectedSurface);
        }

        [DataTestMethod, TestCategory("Surface")]
        [DataRow(10, 4.02)]
        [DataRow(1, 0.42)]
        public void Surface_Test_1_Param(double a, double expectedSurface)
        {
            Pudelko p = new Pudelko(a);
            Assert.AreEqual(p.Surface, expectedSurface);
        }
        ...
        [DataTestMethod, TestCategory("Surface")]
        [DataRow(10, 2, 5, UnitOfMeasure.centimeter, 0.016)]
        public void Surface_Test_3_Param_Centimeter(double a, double b, double c, UnitOfMeasure unit, double expectedSurface)
        {
            Pudelko p = new Pudelko(a, b, c, unit);
            Assert.AreEqual(p.Surface, expectedSurface);
        }
        ...
        [DataTestMethod, TestCategory("Equals")]
        [DataRow(2, 5, 1, 3, 4, 1, false)]
        [DataRow(5, 10, 5, 6, 10, 5, false)]
        ...
        [DataTestMethod, TestCategory("Equals")]
        [DataRow(2, 5, 1, 3, 4, 1, false)]
        [DataRow(200, 500, 100, 2, 5, 1, true)]
